    ...
    <div className="p-6 border-4 border-white bg-gray-800 shadow-xl mb-12 transform -skew-y-1">
      ...
      <div className="flex items-center space-x-4">
        ...
        <select
          ...
          // FIX: Uklonjen je problematičan style i JSX atribut 'global'.
          // Koristimo kombinaciju standardnih Tailwind klasa
          className="flex-grow p-3 border-2 border-red-600 bg-black text-white font-mono text-lg focus:outline-none focus:ring-2 focus:ring-yellow-400 appearance-none 
                     bg-no-repeat bg-[length:1.2rem] bg-[position:right_0.5rem_center]"
          // Dodajemo inline style za strelicu kao SVG URL
